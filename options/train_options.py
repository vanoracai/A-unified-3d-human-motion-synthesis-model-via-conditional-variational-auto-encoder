...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        ## my own change
        parser.add_argument('--nepoch', type=int, default=40, help='the starting epoch count')
        parser.add_argument('--pro_train', type=bool, default=True, help='for debug: if process training')
        parser.add_argument('--pro_test', type=bool, default=True, help='for debug: if process testing')
        parser.add_argument('--save_latest_model', type=bool, default=True, help='save the latest model if needed')
        self.isTrain = True
